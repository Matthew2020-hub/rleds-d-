...
class User(AbstractUser):
    ...
    profile_image = models.ImageField(upload_to = 'profile/', blank=True ,null=True, default='daa.png')
    background_image = models.ImageField(upload_to = 'profile/', blank=True, null=True, default='./static/daa.png')
