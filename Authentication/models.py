...
class User(AbstractUser):
    ...
    profile_image = models.ImageField(upload_to = 'profile/', blank=True,null=True, default='https://nigerianbuildingdesigns.com/wp-content/uploads/2021/01/3-2-1.jpg')
    background_image = models.ImageField(upload_to = 'profile/', blank=True,null=True, default='https://nigerianbuildingdesigns.com/wp-content/uploads/2021/01/3-2-1.jpg')
