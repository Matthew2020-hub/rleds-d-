...
class TestViews(TestSetUp):
    ...
    def test_forgetPassword_endpoint(self):
        ...
        response.is_active = True
        response.save()
        password_reset = self.client.put((self.forgetPassword_url + str(response.user_id)), self.forgetPassword_data)
    ...
    def test_get_and_delete_user_endpoint(self):
        ...
        delete_user = self.client.delete((self.getAndDeleteUser_url + str(response.user_id)))
    ...
    def test_get_and_delete_agent_endpoint(self):
        ...
        delete_user = self.client.delete((self.getAndDeleteAgent_url + str(response.user_id)))
        self.assertEqual(get_user.status_code, 200)
