...
class TestSetUp(APITestCase):
    ...
    def test_post_apartment(self):
        user_registration = self.client.post(self.register_url, self.user_data, format='json')
        ...
        self.assertEqual(get_profile.data['full_name'], user_registration.data['data']['name'] )
